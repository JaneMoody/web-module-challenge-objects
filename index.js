...
console.log(createMenuItem("Burger", 2, "Supper"));
console.log(createMenuItem("Fries", 1, "Breakfast"));
...
function changeRating(name, index, feedback) {
  name[index].feedback = feedback;
  return name;
}
